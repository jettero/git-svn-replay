...
# ./git_svn_replay -d s.rdb /home/git/git_svn_replay s.co/gsr_master
# ./git_svn_replay -d s.rdb git@github.com:jettero/git_svn_replay.git s.co/gsr_public

# this repo has merges in it... better test all the way around
# ./git_svn_replay -d s.rdb git://github.com/jettero/videodump-pl.git s.co/vd-pl
  ./git_svn_replay -d s.rdb ~/code/perl/videodump-pl s.co/vd-pl
